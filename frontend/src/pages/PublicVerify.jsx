...
export const PublicVerify = ({ certificateId, onNavigate }) => {
  ...
  return (
    <div style={{ maxWidth: '580px', margin: '2rem auto', padding: '1rem' }}>
      ...
      {error ? (
        <div className="card" style={{ textAlign: 'center', padding: '2rem', border: '1px solid #FECACA', backgroundColor: '#FEF2F2' }}>
        ...
        certData && (
          <div className="card" style={{ border: '2px solid #007A64', padding: '1.75rem' }}>
            ...
            <div style={{ textAlign: 'center', paddingBottom: '1.25rem', borderBottom: '1px solid #E2E8F0', marginBottom: '1.25rem' }}>
              ...
              <div style={{ fontSize: '1.5rem', fontWeight: '800', fontFamily: 'monospace', color: '#0F2537' }}>
